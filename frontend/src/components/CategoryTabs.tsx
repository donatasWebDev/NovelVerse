...
export const CategoryTabs = ({
  ...
  return <div className="flex gap-2 mb-8 overflow-x-auto pb-2 scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-500">
